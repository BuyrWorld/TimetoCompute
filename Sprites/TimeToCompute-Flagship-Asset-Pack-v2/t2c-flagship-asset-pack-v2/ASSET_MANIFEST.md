# Asset Manifest (legacy v1 stage assets)

For the authoritative v2 machine-readable manifest covering homepage, Photonics and AI News assets, use `ASSET_MANIFEST_V2.json`. This document remains useful for the inherited stage-master provenance and size notes only.
