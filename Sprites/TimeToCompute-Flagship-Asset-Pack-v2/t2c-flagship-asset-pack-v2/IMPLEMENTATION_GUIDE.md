# Implementation Guide (foundation notes)

The authoritative v2 sequence is `docs/IMPLEMENTATION_PLAN.md`. The rules below remain valid for inherited v1 stage assets unless a v2 document states otherwise.
